...
namespace HtmlTools
{
    ...
    {
        private static readonly BitmapFrame noPreview = Freeze(BitmapFrame.Create(new Uri("pack://application:,,,/HtmlTools(ABP Suport);component/Resources/nopreview.png")));
        ...
        public void AugmentQuickInfoSession(IQuickInfoSession session, IList<object> qiContent, out ITrackingSpan applicableToSpan)
        {
            ...
            tree.GetPositionElement(point.Value.Position, out Microsoft.WebTools.Languages.Html.Tree.Nodes.ElementNode node, out Microsoft.WebTools.Languages.Html.Tree.Nodes.AttributeNode attr);
        ...
        public static void AddImageContent(IList<object> qiContent, string url)
        {
            ...
            ITextBuffer size = WebEditor.ExportProvider.GetExport<ITextBufferFactoryService>().Value.CreateTextBuffer();
